...
<body>
	...
	<form class="login-form text-center" action="CRUDcliente"
		...
		<div class="form-group">
			<input type="txt" name="txtIdentidad"
				class="form-control rounded-pill form-control-lg"
		...
		<div class="form-group">
			<input type="txt" name="txtTarjeta_Credito"
				class="form-control rounded-pill form-control-lg"
		...
		<button type="submit" name="accion" value="Guardar"
			class="btn mt-5 rounded-pill btn-lg btn-custom btn-block text-uppercase">Guardar</button>

...
<body>
	...
	<form class="login-form text-center" action="CRUDcliente"
		method="post">
		...
		<div class="form-group">
			<label>Nombre</label> <input type="text" name="txtNombre"
				...
				value="${tb_cliente.getNombre_Cliente()}">
		</div>
		<div class="form-group">
			<label>Identidad</label> <input type="txt" name="txtIdentidad"
				class="form-control rounded-pill form-control-lg"
				value="${tb_cliente.getIdentidad_Cliente()}">
		</div>
		<div class="form-group">
			<label>Email</label> <input type="txt" name="txtEmail"
				class="form-control rounded-pill form-control-lg"
				value="${tb_cliente.getEmail()}">
		</div>
		<div class="form-group">
			<label>Tipo Pago</label> <input type="txt" name="txtTarjeta_Credito"
				class="form-control rounded-pill form-control-lg"
				value="${tb_cliente.getTarjeta_Credito()}">
		</div>
